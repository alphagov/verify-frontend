...
SHORT_HUB = "short_hub".freeze

# HUB-109 Short HUB A/B test
short_hub_control_piwik = SelectRoute.new(SHORT_HUB, 'control', is_start_of_test: true, experiment_loa: 'LEVEL_2')
short_hub_control = SelectRoute.new(SHORT_HUB, 'control', is_start_of_test: false, experiment_loa: 'LEVEL_2')
short_hub_variant_piwik = SelectRoute.new(SHORT_HUB, 'variant', is_start_of_test: true, experiment_loa: 'LEVEL_2')
short_hub_variant = SelectRoute.new(SHORT_HUB, 'variant', is_start_of_test: false, experiment_loa: 'LEVEL_2')
