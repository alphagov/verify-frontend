...
no_questions_v2_control = SelectRoute.new(NO_QUESTIONS_V2, 'control', is_start_of_test: false, experiment_loa: 'LEVEL_2')
no_questions_v2_variant_piwik = SelectRoute.new(NO_QUESTIONS_V2, 'variant', is_start_of_test: true, experiment_loa: 'LEVEL_2')
no_questions_v2_variant = SelectRoute.new(NO_QUESTIONS_V2, 'variant', is_start_of_test: false, experiment_loa: 'LEVEL_2')
