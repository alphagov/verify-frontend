...
NO_PERF_MANAGEMENT = 'no_perf_management'.freeze

no_perf_management_control_piwik = SelectRoute.new(NO_PERF_MANAGEMENT, 'control', is_start_of_test: true)
no_perf_management_control = SelectRoute.new(NO_PERF_MANAGEMENT, 'control', is_start_of_test: false)
no_perf_management_variant_piwik = SelectRoute.new(NO_PERF_MANAGEMENT, 'variant', is_start_of_test: true)
no_perf_management_variant = SelectRoute.new(NO_PERF_MANAGEMENT, 'variant', is_start_of_test: false)
