LOA1_SHORTENED_JOURNEY_EXPERIMENT = 'loa1_shortened_journey_v2'.freeze

loa1_shortened_control_piwik = SelectRoute.new(LOA1_SHORTENED_JOURNEY_EXPERIMENT, 'control', true, 'LEVEL_1')
loa1_shortened_variant_get_setup_piwik = SelectRoute.new(LOA1_SHORTENED_JOURNEY_EXPERIMENT, 'variant_get_setup', true, 'LEVEL_1')
loa1_shortened_variant_create_account_piwik = SelectRoute.new(LOA1_SHORTENED_JOURNEY_EXPERIMENT, 'variant_create_account', true, 'LEVEL_1')
