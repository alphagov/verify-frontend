Rails.application.routes.draw do
  ...
  IDP_WARNING_TEXT_EXPERIMENT = 'idp_warning_text'.freeze
  ...
  # example_experiment_name_and_report_to_piwik = SelectRoute.new(EXAMPLE_EXPERIMENT, 'control', report_to_piwik)
  # example_experiment_variant_name_and_report_to_piwik = SelectRoute.new(EXAMPLE_EXPERIMENT, 'variant', report_to_piwik)
  # example_experiment_name = SelectRoute.new(EXAMPLE_EXPERIMENT, 'control')
  # example_experiment_variant_name = SelectRoute.new(EXAMPLE_EXPERIMENT, 'variant')

  redirect_to_idp_warning_a = SelectRoute.new(IDP_WARNING_TEXT_EXPERIMENT, 'control', report_to_piwik)
  redirect_to_idp_warning_b = SelectRoute.new(IDP_WARNING_TEXT_EXPERIMENT, 'variant_heading_account', report_to_piwik)
  redirect_to_idp_warning_c = SelectRoute.new(IDP_WARNING_TEXT_EXPERIMENT, 'variant_heading_website', report_to_piwik)
  ...
  localized do
    ...
    constraints redirect_to_idp_warning_a do
      get 'redirect_to_idp_warning', to: 'redirect_to_idp_warning#index', as: :redirect_to_idp_warning
    end

    constraints redirect_to_idp_warning_b do
      get 'redirect_to_idp_warning', to: 'redirect_to_idp_warning#index_variant_heading_account', as: :redirect_to_idp_warning
    end

    constraints redirect_to_idp_warning_c do
      get 'redirect_to_idp_warning', to: 'redirect_to_idp_warning#index_variant_heading_website', as: :redirect_to_idp_warning
    end
  end
