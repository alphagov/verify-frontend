...
Rails.application.config.after_initialize do
  ...
  idp_rules_variant = idp_rules_loader.parse_config_files(CONFIG.rules_directory_variant)
  ...
  IDP_RECOMMENDATION_ENGINE_VARIANT = RecommendationsEngine.new(idp_rules_variant, segment_matcher, transaction_grouper)
