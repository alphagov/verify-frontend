...
RSpec.feature "user visits the choose a certified company about idp page", type: :feature do
  ...
  scenario "user chooses a recommended idp" do
    ...
    expect(page.get_rack_session_key("selected_provider")["identity_provider"]).to include("entity_id" => entity_id, "simple_id" => "stub-idp-one", "levels_of_assurance" => [LevelOfAssurance::LOA1, LevelOfAssurance::LOA2])
