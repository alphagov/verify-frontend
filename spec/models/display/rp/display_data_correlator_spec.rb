  ...
  module Rp
    describe DisplayDataCorrelator do
      ...
      it 'translates and filters the transactions according to the relying_parties config' do
        ...
        expected_result = DisplayDataCorrelator::Transactions.new(
          [DisplayDataCorrelator::Transaction.new(transaction_a_name, homepage, public_simple_id_loa)],
          [DisplayDataCorrelator::Transaction.new(transaction_b_name, private_simple_id_loa)])
        expect(actual_result).to eq expected_result
      end
      ...
      it 'errors when homepage is missing' do
        transaction_data = { 'transactions' => [{ 'simpleId' => public_simple_id, 'loaList' => public_simple_id_loa }, { 'simpleId' => private_simple_id, 'loaList' => private_simple_id_loa }] }
        expect {
          display_data_correlator.correlate(transaction_data)
        }.to raise_error KeyError
      end
