...
require 'models/display/identity_provider_display_decorator_variant'
...
module Display
  describe IdentityProviderDisplayDecoratorVariant do
    let(:repository) { double(:repository) }
    let(:decorator) { IdentityProviderDisplayDecoratorVariant.new(repository, '/stub-logos', '/stub-logos/white') }
